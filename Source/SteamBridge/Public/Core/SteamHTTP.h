...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FiveParams(FOnHTTPRequestCompletedDelegate, int32, RequestHandle, int64, ContextValue, bool, bRequestSuccessful, ESteamHTTPStatus::Type, HTTPStatus, int32, BodySize);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FOnHTTPRequestDataReceivedDelegate, int32, RequestHandle, int64, ContextValue, int32, Offset, int32, BytesReceived);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnHTTPRequestHeadersReceivedDelegate, int32, RequestHandle, int64, ContextValue);
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamBridgeCore|HTTP")
	bool GetHTTPResponseBodySize(int32 RequestHandle, int32& BodySize);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamBridgeCore|HTTP")
	bool GetHTTPResponseHeaderSize(int32 RequestHandle, const FString& HeaderName, int32& ResponseHeaderSize);
	 ...
	 *
	 * @param int32 CookieContainerHandle
	 * @return bool
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamBridgeCore|HTTP")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamBridgeCore|HTTP")
	bool SendHTTPRequest(int32 RequestHandle, FSteamAPICall& CallHandle);
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "SteamBridgeCore|HTTP")
	bool SendHTTPRequestAndStreamResponse(int32 RequestHandle, FSteamAPICall& CallHandle);
